...
<body>
    ...
    <div class="header">
      <h1>RESOURCE ANALYST REGISTRATION</h1>
            ...
            <tbody>
                ...
                <%
                    ...
                    try {
                        ...
                        String sql = "SELECT * FROM resource_analyst ";
                ...
                <tr>
                    ...
                    <td>
                        <form action="SendEmailServlet" method="post">
                            <button class="btn-update"   type="submit">Accept</button>
                        ...
                        <form action="DeleteAccess" method="post">
                            ...
                            <input type="hidden" name="role" value="<%= rs.getString("role") %>">
                            <br>
                            <button class="btn-delete"  type="submit">Deny</button>
                        </form>
                    </td>
                </tr>
                <%
