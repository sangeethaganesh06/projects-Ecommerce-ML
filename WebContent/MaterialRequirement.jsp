...
<body>
 <button1 class="button1" onclick="window.location.href='ResourceAnalystPage.html'" >BACK</button1>
   
    <div class="container">
        <h1>Stock Material Upload</h1>
        <form id="uploadForm" action="MaterialRequirementUpload" method="post" enctype="multipart/form-data">
