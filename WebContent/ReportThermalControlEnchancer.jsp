...
<body>
    ...
    <div class="container">
        <h1>THERMAL ENHANCER ANALYSIS REPORT</h1>
        ...
        </div> <button class="btn-animated" onclick="handleButtonClick()">Get Approve</button>
    </div>
 <script>
function handleButtonClick() {
    alert('Successfully thermal control report submitted');
