...
<body>
 ...
 <button1 class="button1" onclick="window.location.href='PerformanaceEfficiencyPage.jsp'" >BACK</button1>
   
    <div class="container">
      
         <h1>REFURBISHED PRODUCT LIST UPLOAD</h1>
        <form id="uploadForm" action="UploadRefurbishedProduct" method="post" enctype="multipart/form-data">
